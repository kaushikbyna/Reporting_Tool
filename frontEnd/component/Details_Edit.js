...
const  Details_Edit = (props)=> {
  ...
  const handleSubmit = e =>{
    ...
    if(validate())
    props.update(props.currentId,values,submit)
    console.log(values)
    }
        ...
        <div className="details_edit">
            ...
            <div className="edit_middle">
                <div className="edit_middle_left">
                    <p className="left_title">Update Project</p>
...
export default connect (mapStatesToProps,mapActionsToProps)(Details_Edit);
